...
export function validarBodyLaboratorio(req, res, next) {
    /*
    Descripcion:
    Middleware encargado de interceptar y validar el cuerpo (body) de la peticion HTTP para asegurar que los datos obligatorios de laboratorio esten presentes y cumplan con los formatos esperados antes de pasar al controlador.
    Parametros:
