...
-- ------------------------------------------------------------------------------
-- 0. DATOS BASE DEL SISTEMA (ADMINISTRADOR GLOBAL CAPROCAM)
-- ------------------------------------------------------------------------------

INSERT INTO usuarios (grupo_datos, nombre, apellidos, email, nombre_usuario, password_hash, activo) VALUES
(22776226, 'Administrador', 'Sistema', 'admin@caprocam.local', 'admin', '$2b$10$NuxtO925LglHJtx3CmDnROVHip/58kvWhpcKC4dF5XcQV3Mh9N1Di', TRUE);

-- ------------------------------------------------------------------------------
-- 1. TABLA: usuarios
-- ------------------------------------------------------------------------------
INSERT INTO usuarios (id, uuid, grupo_datos, nombre, apellidos, email, nombre_usuario, password_hash, activo) VALUES
(2, UUID(), 1001, 'Carlos', 'Mendoza Solano', 'cmendoza@caprocam.com', 'admin_carlos', '$2a$12$lbJP0Yno2WF3mxI.deIeYO2PuC0KdvFf1Ku3kT4N5TLpuRxqSFxV2', TRUE),
(3, UUID(), 1001, 'Maria', 'Jimenez Castro', 'mjimenez@caprocam.com', 'gerente_maria', '$2a$12$lbJP0Yno2WF3mxI.deIeYO2PuC0KdvFf1Ku3kT4N5TLpuRxqSFxV2', TRUE),
(4, UUID(), 1002, 'Roberto', 'Vargas Quiros', 'rvargas@surcamaron.com', 'biologo_roberto', '$2a$12$lbJP0Yno2WF3mxI.deIeYO2PuC0KdvFf1Ku3kT4N5TLpuRxqSFxV2', TRUE);
...
-- ------------------------------------------------------------------------------
INSERT INTO colaboradores (id, uuid, grupo_datos, finca_id, nombre, apellidos, cedula, telefono, email, nombre_usuario, pin_hash, tipo_colaborador, activo) VALUES
(1, UUID(), 1001, 1, 'Juan', 'Perez Morales', '601230456', '+506 7011-2233', 'jperez@gmail.com', 'jperez_maragal', '$2a$12$mbFWdJTd5ZkAaKdzEFm1j.TN2B4ZTQXTkVKshvsP5l/T6ViTn.l.6', 'external_collab', TRUE),
(2, UUID(), 1001, 1, 'Laura', 'Sanchez Mora', '109870654', '+506 7022-3344', 'lsanchez@caprocam.com', 'lsanchez_tec', '$2a$12$mbFWdJTd5ZkAaKdzEFm1j.TN2B4ZTQXTkVKshvsP5l/T6ViTn.l.6', 'caprocam_collab', TRUE),
(3, UUID(), 1002, 3, 'Esteban', 'Araya Cruz', '503210987', '+506 7033-4455', 'earaya@surcamaron.com', 'earaya_golfo', '$2a$12$mbFWdJTd5ZkAaKdzEFm1j.TN2B4ZTQXTkVKshvsP5l/T6ViTn.l.6', 'external_owner', TRUE);
...
-- 6. TABLA: tareas
-- ------------------------------------------------------------------------------
INSERT INTO tareas (id, uuid, grupo_datos, codigo_tarea, nombre, descripcion, categoria, horas, activo) VALUES
(1, UUID(), 1001, 'TAR-01', 'Cambio de Aceite y Filtros', 'Sustitucion de aceite de motor diesel y filtros de aire/combustible', 'Preventivo', 2.50, TRUE),
(2, UUID(), 1001, 'TAR-02', 'Revision de Transmision Aireador', 'Verificacion de pinones, grasa y sello mecanico de reductor', 'Preventivo', 1.50, TRUE),
(3, UUID(), 1001, 'TAR-03', 'Reparacion Impulsor de Bomba', 'Cambio de rodamiento danado por corrosion marina', 'Correctivo', 4.00, TRUE),
(4, UUID(), 1002, 'TAR-04', 'Calibracion de Sensores de Oxigeno', 'Calibracion de membrana y solucion estandar de sonda YSI', 'Predictivo', 1.00, TRUE);

-- ------------------------------------------------------------------------------
-- 7. TABLA: mantenimiento_equipo
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 8. TABLA: mantenimiento_equipo_tareas
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 11. TABLA: mantenimiento_equipo_productos
-- ------------------------------------------------------------------------------
...
-- 19. TABLA: siembras
-- ------------------------------------------------------------------------------
INSERT INTO siembras (id, uuid, grupo_datos, lote_larva_id, precria_id, finca_id, estanque_id, fecha_siembra, tecnica_cultivo, densidad_poblacional, cantidad_sembrada, pl_siembra, duracion_ciclo, produccion_kg, estado, activo) VALUES
(1, UUID(), 1001, 1, NULL, 1, 1, '2026-05-10', 'Semi-intensivo monofasico', 15.00, 1500000, 10, 100, 0.00, 'Activa', TRUE),
(2, UUID(), 1001, 2, 1, 1, 1, '2026-06-22', 'Bifasico trasplante precria', 14.80, 740000, 25, 80, 0.00, 'Activa', TRUE);

-- ------------------------------------------------------------------------------
-- 20. TABLA: crecimientos
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 20.1 TABLA: calculos_crecimiento
-- ------------------------------------------------------------------------------
...
-- 22. TABLA: ventas
-- ------------------------------------------------------------------------------
INSERT INTO ventas (id, uuid, grupo_datos, finca_id, estanque_id, creado_por_colaborador_id, comprador_id, peso_promedio, cantidad_vendida, precio_kilo, total, fecha, activo) VALUES
(1, UUID(), 1001, 1, 1, 1, 1, 15.20, 3500.00, 3200.00, 11200000.00, '2026-07-25', TRUE);

-- ------------------------------------------------------------------------------
-- 23. TABLA: parasitologias
-- ------------------------------------------------------------------------------
INSERT INTO parasitologias (id, uuid, grupo_datos, finca_id, estanque_id, tipo_registro, fecha_reporte, responsable, parasito, observaciones, creado_por_colaborador_id, activo) VALUES
(1, UUID(), 1001, 1, 1, 'Rutina Semanal', '2026-07-12', 'Dra. Laura Sanchez', 'gregarina', 'Presencia leve de gregarinas en intestino medio. Sin impacto en consumo de alimento.', 2, TRUE);

-- ------------------------------------------------------------------------------
-- 24. TABLA: enfermedades
-- ------------------------------------------------------------------------------
INSERT INTO enfermedades (id, uuid, grupo_datos, finca_id, estanque_id, tipo_registro, fecha_reporte, responsable, enfermedad, severidad, reporte, creado_por_colaborador_id, activo) VALUES
(1, UUID(), 1001, 1, 1, 'Muestreo Preventivo PCR', '2026-07-15', 'Dra. Laura Sanchez', 'Vibriosis', 'medio', 'Se detecta leve incremento de colonias amarillas en agar TCBS. Se aplica probiotico bacteriano en agua.', 2, TRUE);

-- ------------------------------------------------------------------------------
-- 25. TABLA: alimentaciones
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 26. TABLA: densidad_poblacional
-- ------------------------------------------------------------------------------
INSERT INTO densidad_poblacional (id, uuid, grupo_datos, finca_id, estanque_id, creado_por_colaborador_id, fecha, cantidad_siembra, area_estanque, total_camarones_muestra, tiros_atarraya, area_atarraya, area_muestreada, promedio_por_tiro, poblacion_estimada, sobrevivencia, densidad, notas_conteo, activo) VALUES
(1, UUID(), 1001, 1, 1, 1, '2026-07-20', 1500000, 5000.00, 225, 10, 3.14, 31.40, 22.50, 1125000, 75.00, 11.25, 'Conteo mediante atarrayado circular de 2m de diametro. Buena distribucion uniforme.', TRUE);

-- ------------------------------------------------------------------------------
-- 27. TABLA: densidad_detalle_tiros
-- ------------------------------------------------------------------------------
INSERT INTO densidad_detalle_tiros (id, uuid, grupo_datos, densidad_id, numero_tiro, cantidad_camarones) VALUES
(1, UUID(), 1001, 1, 1, 20),
(2, UUID(), 1001, 1, 2, 22),
(3, UUID(), 1001, 1, 3, 23),
(4, UUID(), 1001, 1, 4, 24),
...
(8, UUID(), 1001, 1, 8, 23),
(9, UUID(), 1001, 1, 9, 22),
(10, UUID(), 1001, 1, 10, 23);

-- ------------------------------------------------------------------------------
-- 28. TABLA: raleos
-- ------------------------------------------------------------------------------
INSERT INTO raleos (id, uuid, grupo_datos, finca_id, estanque_id, siembra_id, creado_por_colaborador_id, fecha, porcentaje, kg_retirados, biomasa_restante, biomasa_estimada, observaciones, activo) VALUES
(1, UUID(), 1001, 1, 1, 1, 1, '2026-07-24', 15.00, 2445.00, 13855.00, 16300.00, 'Raleo parcial nocturno sin inconvenientes de temperatura.', TRUE);

-- ------------------------------------------------------------------------------
-- 29. TABLA: fisico_quimico
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 30. TABLA: fisico_quimico_detalle
-- ------------------------------------------------------------------------------
