...
(1, 'Administrador', 'Sistema', 'admin@caprocam.local', 'admin', '$2b$10$NuxtO925LglHJtx3CmDnROVHip/58kvWhpcKC4dF5XcQV3Mh9N1Di', TRUE);
...
-- ------------------------------------------------------------------------------
-- 9. TABLA: mantenimiento_equipo_tareas
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 12. TABLA: mantenimiento_equipo_productos
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 25. TABLA: enfermedades
-- ------------------------------------------------------------------------------
INSERT INTO enfermedades (id, uuid, grupo_datos, finca_id, estanque_id, tipo_registro, fecha_reporte, responsable, enfermedad, severidad, reporte, creado_por_usuario_id, creado_por_colaborador_id, activo) VALUES
(1, UUID(), 1001, 1, 1, 'Muestreo Preventivo PCR', '2026-07-15', 'Dra. Laura Sanchez', 'Vibriosis', 'medio', 'Se detecta leve incremento de colonias amarillas en agar TCBS. Se aplica probiotico bacteriano en agua.', NULL, 2, TRUE);

-- ------------------------------------------------------------------------------
-- 26. TABLA: alimentaciones
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 28. TABLA: densidad_detalle_tiros
-- ------------------------------------------------------------------------------
INSERT INTO densidad_detalle_tiros (id, uuid, densidad_id, numero_tiro, cantidad_camarones) VALUES
(1, UUID(), 1, 1, 20),
(2, UUID(), 1, 2, 22),
(3, UUID(), 1, 3, 23),
(4, UUID(), 1, 4, 24),
