...
export class SiembraDTO {
    constructor({
        ...
        /*
        Descripcion:
        DTO de entrada para una Siembra.
 
        Parametros:
        - lote_larva_id:         ID del lote de larva (requerido).
        - precria_id:            ID de la pre-cria de origen (opcional; si no
                                  se indica, la siembra parte directo del lote).
        - finca_id:               ID de la finca (requerido).
        - estanque_id:            ID del estanque (requerido).
        - fecha_siembra:          Fecha de la siembra (requerido).
        - tecnica_cultivo:        Tecnica de cultivo usada (opcional).
        - densidad_poblacional:   Densidad poblacional, DECIMAL(10,2) (opcional).
        - cantidad_sembrada:      Cantidad sembrada (requerido).
        - pl_siembra:             PL al momento de la siembra (opcional).
